...
$(document).ready(function() {
	...
	//Busca no BD e exibe na página os produtos que atendam à solicitção do usuário
	...
	//Transforma os dados dos procutos recebidos do serviro em uma tabela HTML
